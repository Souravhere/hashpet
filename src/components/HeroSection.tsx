            ...
            <div className="text-center">
              ...
              <div className="mt-10 sm:flex sm:justify-center">
                ...
                >
                  <a
                    href="#"
                    className="w-full flex hidden items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 md:py-4 md:text-lg md:px-10"
                  >
                    Get Started
                  </a>
                </motion.div>
