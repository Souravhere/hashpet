        ...
        <div className='sm:flex block w-full sm:h-[450px] h-fit my-5'>
          ...
          <div className='sm:w-1/2 w-full bg-white flex items-center justify-between sm:h-full h-fit px-3'>
            <div>
              ...
              {/* here is svg */}
              <p className='text-base text-center sm:w-[70%] mx-auto'>
              This service is for your pet’s health and medical management.PetDoc prioritizes the health of pets by providing a variety of medical-related services. We help pet owners manage their pets' health more easily
              </p>
            </div>
          </div>
          {/* this is img section */}
